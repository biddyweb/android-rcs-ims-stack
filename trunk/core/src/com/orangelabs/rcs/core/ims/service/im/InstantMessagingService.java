...
public class InstantMessagingService extends ImsService {
    ...
    public void receivePagerInstantMessage(SipRequest im) {
	    ...
	    // Get content type
	    String contentType = im.getContentType();
	    if (contentType.equalsIgnoreCase("text/plain")) {
		    InstantMessage message = new InstantMessage(SipUtils.getAssertedIdentity(im), im.getContent());
    ...
    public void receiveOne2OneChatSession(SipRequest invite) {
		...
		// Test if the contact is not blocked
