...
public class ContentSharingService extends ImsService {
     ...
     */
    public final static String[] FEATURE_TAGS_VIDEO_SHARE = {SipUtils.FEATURE_RCSE_VIDEO_SHARE};
    
    /**
     * Image share features tags
     */
    public final static String[] FEATURE_TAGS_IMAGE_SHARE = {SipUtils.FEATURE_RCSE_IMAGE_SHARE};
