...
public class RcsSettings {
	...
	private void writeParameter(String key, String value) {
		// TODO: test if parameter is readonly or not
	...
	public boolean isAutoAcceptModeForChatInvitation(){
		boolean result = false;
		if (instance != null) {
			return Boolean.parseBoolean(readParameter(RcsSettingsData.CHAT_INVITATION_AUTO_ACCEPT));
		}
		return result;
	}
	...
	/**
	 * Get user profile IMS proxy (i.e. P-CSCF or outbound proxy)
	 * 
	 * @return Address as <host>:<port>
	 */
	public String getUserProfileImsProxy() {
		String result = null;
		if (instance != null) {
			return readParameter(RcsSettingsData.USERPROFILE_IMS_PROXY);
		}
		return result;
	}	

	/**
	 * Set user profile IMS proxy (i.e. P-CSCF or outbound proxy)
	 * 
	 * @param addr Address as <host>:<port>
	 */
	public void setUserProfileImsProxy(String addr) {
		if (instance != null) {
			writeParameter(RcsSettingsData.USERPROFILE_IMS_PROXY, addr);
		}
	}
	...
	/**
	 * Get max number of RCS contacts or enriched contacts
	 * 
	 * @return Number of contacts 
	 */
	public int getMaxRcsContacts() {
		int result = 20;
		if (instance != null) {
			try {
				return Integer.parseInt(readParameter(RcsSettingsData.MAX_RCS_CONTACTS));
			} catch(Exception e) {}
		}
		return result;
	}
	...
	public int getMaxChatMessageLength() {
		...
		if (instance != null) {
			try {
				return Integer.parseInt(readParameter(RcsSettingsData.MAX_CHAT_MSG_LENGTH));
			} catch(Exception e) {}
		}
		return result;
	}
	...
	public int getMaxFileTransferSessions() {
		...
		if (instance != null) {
			try {
				return Integer.parseInt(readParameter(RcsSettingsData.MAX_FILE_TRANSFER_SESSIONS));
			} catch(Exception e) {}
		}
		return result;
	}
	...
	/**
	 * Is anonymous fetch service activated
	 * 
	 * @return Boolean
	 */
	public boolean isAnonymousFetchServiceActivated() {
		boolean result = false;
		if (instance != null) {
			return Boolean.parseBoolean(readParameter(RcsSettingsData.ANONYMOUS_FETCH_SERVICE));
		}
		return result;
	}
	...
	public boolean isChatServiceActivated() {
		boolean result = false;
		if (instance != null) {
			return Boolean.parseBoolean(readParameter(RcsSettingsData.CHAT_SERVICE));
		}
		return result;
	}
	...
	public int getImsConnectionPollingPeriod() {
		...
		if (instance != null) {
			try {
				return Integer.parseInt(readParameter(RcsSettingsData.IMS_CONNECTION_POLLING_PERIOD));
			} catch(Exception e) {}
		}
		return result;
	}
	...
	/**
	 * Get anonymous refresh timeout used to decide when to refresh the internal cache
	 * 
	 * @return Timeout in seconds 
	 */
	public int getAnonymousFetchRefrehTimeout() {
		int result = 300;
		if (instance != null) {
			try {
				return Integer.parseInt(readParameter(RcsSettingsData.ANONYMOUS_FETCH_REFRESH_TIMEOUT));
			} catch(Exception e) {}
		}
		return result;
	}
	...
	/**
	 * Get IMS authentication procedure
	 * 
	 * @return Authentication procedure ("GIBA" or "DIGEST")
	 */
	public String getImsAuhtenticationProcedure() {
		String result = null;
		if (instance != null) {
			return readParameter(RcsSettingsData.IMS_AUTHENT_MODE);
		}
		return result;
	}
	...
	public int getIsComposingTimeout() {
		...
		if (instance != null) {
			try {
				return Integer.parseInt(readParameter(RcsSettingsData.IS_COMPOSING_TIMEOUT));
			} catch(Exception e) {}
		}
		return result;
	}
	...
	/**
	 * Is CS video capability supported
	 * 
	 * @return Boolean
	 */
	...
	/**
	 * Is file transfer capability supported
	 * 
	 * @return Boolean
	 */
	...
	/**
	 * Is image share capability supported
	 * 
	 * @return Boolean
	 */
	public boolean isImageSharingSupported() {
		boolean result = false;
		if (instance != null) {
			return Boolean.parseBoolean(readParameter(RcsSettingsData.CAPABILITY_IMAGE_SHARE));
		}
		return result;
	}
	
	/**
	 * Is video share capability supported
	 * 
	 * @return Boolean
	 */
	public boolean isVideoSharingSupported() {
		boolean result = false;
		if (instance != null) {
			return Boolean.parseBoolean(readParameter(RcsSettingsData.CAPABILITY_VIDEO_SHARE));
		}
		return result;
	}
	
	/**
	 * Is IM session capability supported
	 * 
	 * @return Boolean
	 */
	public boolean isImSessionSupported() {
		boolean result = false;
		if (instance != null) {
			return Boolean.parseBoolean(readParameter(RcsSettingsData.CAPABILITY_IM_CAPABILITY));
		}
		return result;
	}
	
	/**
	 * Is rich call mode activated. If richcall mode is activated, a content sharing
	 * may be initiated only during a CS call.
	 * 
	 * @return Boolean
	 */
	public boolean isRichcallModeActivated() {
		boolean result = false;
		if (instance != null) {
			return Boolean.parseBoolean(readParameter(RcsSettingsData.RICHCALL_MODE));
		}
		return result;
	}
