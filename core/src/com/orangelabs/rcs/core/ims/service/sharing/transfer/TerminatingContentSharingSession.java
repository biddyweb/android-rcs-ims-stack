 ...
 * @author jexa7410
 */
public class TerminatingContentSharingSession extends ContentSharingTransferSession implements MsrpEventListener {
	/**
	 * MSRP manager
	 */
	 ...
	 */
	public TerminatingContentSharingSession(ImsService parent, SipRequest invite) {
