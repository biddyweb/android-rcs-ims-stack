...
interface IIPCallApi {
	...
	IIPCallSession initiateCall(in String contact, in IAudioPlayer audioPlayer, in IAudioRenderer audioRenderer, in IMediaPlayer videoPlayer, in IMediaRenderer videoRenderer);
