...
public class PresenceApiService extends IPresenceApi.Stub {
	...
	public boolean setMyPresenceInfo(PresenceInfo info) throws ServerApiException {
		...
		try {
			...
			if (result) {
				// Update Contacts
				ContactsManager.getInstance().setMyPresenceInfo(info);
	...
	public boolean inviteContact(String contact) throws ServerApiException {
		...
		try {
			...
			if (result){
				...
				ContactsManager.getInstance().setContactSharingStatus(contact, RichAddressBookData.STATUS_INVITED, "");
			}
			return result;
		} catch(Exception e) {
	...
	public boolean acceptSharingInvitation(String contact) throws ServerApiException {
		...
		try {
			...
			if (result){
				...
				ContactsManager.getInstance().setContactSharingStatus(contact, RichAddressBookData.STATUS_ACTIVE, "");
			}
			return result;
		} catch(Exception e) {
			throw new ServerApiException(e.getMessage());
	...
	public boolean rejectSharingInvitation(String contact) throws ServerApiException {
		...
		try {
			...
			if (result){
				...
				ContactsManager.getInstance().setContactSharingStatus(contact, RichAddressBookData.STATUS_BLOCKED, "");
			}
			return result;
		} catch(Exception e) {
			throw new ServerApiException(e.getMessage());
	...
	public void ignoreSharingInvitation(String contact) throws ServerApiException {
		...
		try {
			...
			ContactsManager.getInstance().setContactSharingStatus(contact, RichAddressBookData.STATUS_WILLING, "");
		} catch(Exception e) {
			throw new ServerApiException(e.getMessage());
		}
	}
	...
	public boolean revokeContact(String contact) throws ServerApiException {
		...
		try {
			...
			if (result){
				...
				ContactsManager.getInstance().setContactSharingStatus(contact, RichAddressBookData.STATUS_REVOKED, "");
	...
	public Capabilities requestCapabilities(String contact) throws ServerApiException {
		...
		try {
			return Core.getInstance().getPresenceService().requestCapabilities(contact);
		} catch(Exception e) {
			throw new ServerApiException(e.getMessage());
		}
	}
