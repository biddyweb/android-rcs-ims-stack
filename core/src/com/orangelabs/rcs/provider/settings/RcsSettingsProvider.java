...
public class RcsSettingsProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {        	
            ...
            addParameter(db, RcsSettingsData.PUBLISH_EXPIRE_PERIOD, 			"172800", READONLY, REBOOT);
            addParameter(db, RcsSettingsData.ANONYMOUS_FETCH_REFRESH_TIMEOUT, 	"60", READONLY, REBOOT);
            ...
            addParameter(db, RcsSettingsData.SUBSCRIBE_EXPIRE_PERIOD, 			"172800", READONLY, REBOOT);
            addParameter(db, RcsSettingsData.IS_COMPOSING_TIMEOUT, 				"30", READONLY, REBOOT);
            addParameter(db, RcsSettingsData.SESSION_REFRESH_EXPIRE_PERIOD, 	"3600", READONLY, REBOOT);
            addParameter(db, RcsSettingsData.CAPABILITY_CS_VIDEO, 				TRUE, READONLY, REBOOT);
            addParameter(db, RcsSettingsData.CAPABILITY_FILE_TRANSFER, 			TRUE, READONLY, REBOOT);
            addParameter(db, RcsSettingsData.CAPABILITY_IMAGE_SHARE, 			TRUE, READONLY, REBOOT);
            addParameter(db, RcsSettingsData.CAPABILITY_VIDEO_SHARE, 			TRUE, READONLY, REBOOT);
            addParameter(db, RcsSettingsData.CAPABILITY_IM_CAPABILITY, 			TRUE, READONLY, REBOOT);
