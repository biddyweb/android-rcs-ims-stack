...
public class HeaderParser extends Parser {
	...
	protected int wkday() throws ParseException {
		...
		else if (Utils.equalsIgnoreCase(TokenNames.TUE, id))
			return Calendar.TUESDAY;
		else if (Utils.equalsIgnoreCase(TokenNames.WED, id))
			return Calendar.WEDNESDAY;
		else if (Utils.equalsIgnoreCase(TokenNames.THU, id))
			return Calendar.THURSDAY;
		else if (Utils.equalsIgnoreCase(TokenNames.FRI, id))
			return Calendar.FRIDAY;
		else if (Utils.equalsIgnoreCase(TokenNames.SAT, id))
			return Calendar.SATURDAY;
		else if (Utils.equalsIgnoreCase(TokenNames.SUN, id))
	...
	public void setHeaderToParse(String header) throws ParseException {
		if (this.lexer == null)
			...
			throw createParseException("header already set");
	}
