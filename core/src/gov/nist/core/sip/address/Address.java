...
public class Address extends GenericObject {
	...
	/**
	 * Get the port from the imbedded URI. This assumes that a SIP URL is
	 * encapsulated in this address object.
	 * 
	...
	/**
	 * Get the user@host:port for the address field. This assumes that the
	 * encapsulated object is a SipURI.
	 * 
	...
	public String encode() {
		...
		if (displayName != null) {
			encoding.append(Separators.DOUBLE_QUOTE).append(displayName)
					.append(Separators.DOUBLE_QUOTE).append(Separators.SP);
		}
		if (address != null) {
