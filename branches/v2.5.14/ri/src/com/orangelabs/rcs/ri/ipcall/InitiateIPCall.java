...
public class InitiateIPCall extends Activity implements ClientApiListener, ImsEventListener {
	...
	/**
	 * getincoming session when api is connected
	 */
	private Boolean getIncomingSessionWhenApiConnected = false ;
	
	/**
	 * activate buttons when api is connected
	 */
	private Boolean activateButtonsWhenApiConnected = false ;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// if incoming session (intent generated by notif) => launch
		// IPCallSessionActivity
		if ((getIntent() != null) && (getIntent().getAction() != null)
				&& (getIntent().getAction().equals("incoming"))) {
			if (IPCallSessionsData.getInstance().isCallApiConnected) {
				Intent launchIntent = new Intent(getIntent());
				launchIntent
						.setClass(getApplicationContext(), IPCallView.class);
			...
			if (IPCallSessionsData.getInstance().isCallApiConnected) {
				...
				activateButtonsWhenApiConnected = true;
			}
		}
	...
	public void handleApiConnected() {
		...
		if (activateButtonsWhenApiConnected) {
			...
			activateButtonsWhenApiConnected = false;
		}
