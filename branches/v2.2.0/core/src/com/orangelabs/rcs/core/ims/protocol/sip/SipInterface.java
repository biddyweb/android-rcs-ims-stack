...
public class SipInterface implements SipListener {	
	 ...
	 * @throws SipException
	 */
	public SipInterface(String localIpAddress) throws SipException {
		this.localIpAddress = localIpAddress;
		this.defaultProtocol = RcsSettings.getInstance().getSipDefaultProtocol();
		this.defaultListeningPort = RcsSettings.getInstance().getSipListeningPort();
		this.listeningPort = NetworkRessourceManager.generateLocalUdpPort(defaultListeningPort);
	 ...
	 * @return SIP provider
	 */
	private SipProvider getDefaultSipProvider() {
