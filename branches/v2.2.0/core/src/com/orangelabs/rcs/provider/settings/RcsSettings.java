...
public class RcsSettings {
	...
	public String getSipDefaultProtocol() {
		String result = null;
		if (instance != null) {
			return readParameter(RcsSettingsData.SIP_DEFAULT_PROTOCOL);
		}
		return result;
	}
	...
	public boolean isTraceActivated() {
		boolean result = false;
		if (instance != null) {
			return Boolean.parseBoolean(readParameter(RcsSettingsData.TRACE_ACTIVATION));
		}
		return result;
	}
	...
	public boolean isSipTraceActivated() {
		boolean result = false;
		if (instance != null) {
			return Boolean.parseBoolean(readParameter(RcsSettingsData.SIP_TRACE_ACTIVATION));
		}
		return result;
	}
	...
	public boolean isMediaTraceActivated() {
		boolean result = false;
		if (instance != null) {
			return Boolean.parseBoolean(readParameter(RcsSettingsData.MEDIA_TRACE_ACTIVATION));
		}
		return result;
	}
}
