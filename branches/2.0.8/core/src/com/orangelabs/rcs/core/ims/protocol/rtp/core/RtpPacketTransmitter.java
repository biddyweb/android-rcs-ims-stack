...
public class RtpPacketTransmitter {
	...
	public RtpPacketTransmitter(String address, int port) throws IOException {
		...
		// Open the connection
		if (RtpConfig.SYMETRIC_RTP && (RtpPacketReceiver.datagramConnection != null)) {
			datagramConnection = RtpPacketReceiver.datagramConnection;
			if (logger.isActivated()) {
				logger.debug("Use RTP receiver connection (symetric RTP)");				
			}
		} else {
