...
public class NetworkRessourceManager {
    /**
     * Default local UDP port base
     */
    private static int DEFAULT_LOCAL_UDP_PORT_BASE = 10000;

    /**
     * Default local TCP port base
     */
    private static int DEFAULT_LOCAL_TCP_PORT_BASE = 20000;
    ...
    /**
     * Generate a free UDP port number
     * 
     * @return Local UDP port
     */
    public static synchronized int generateLocalUdpPort() {
    	return generateLocalUdpPort(DEFAULT_LOCAL_UDP_PORT_BASE);
    }	
     ...
     */
    public static synchronized int generateLocalTcpPort() {
    	int resp = -1;
		int port = DEFAULT_LOCAL_TCP_PORT_BASE;
		while(resp == -1) {
