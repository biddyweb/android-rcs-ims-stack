...
public class CapabilityService extends ImsService {
	...
	public CapabilityService(ImsModule parent, boolean activated) throws CoreException {
		...
		capabilities.setCsVideoSupport(RcsSettings.getInstance().isCsVideoSupported());
		capabilities.setFileTransferSupport(RcsSettings.getInstance().isFileTransferSupported());
		capabilities.setImageSharingSupport(RcsSettings.getInstance().isImageSharingSupported());
		capabilities.setVideoSharingSupport(RcsSettings.getInstance().isVideoSharingSupported());
		capabilities.setImSessionSupport(RcsSettings.getInstance().isImSessionSupported());
