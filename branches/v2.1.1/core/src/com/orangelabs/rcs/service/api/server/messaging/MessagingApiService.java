...
public class MessagingApiService extends IMessagingApi.Stub {
	 ...
	 * @throws ServerApiException
	 */
	public List<IFileTransferSession> getFileTransferSessions() throws ServerApiException {
		// Test core availability
		ServerApiUtils.testCore();
		
		try {
			ArrayList<IFileTransferSession> result = new ArrayList<IFileTransferSession>();
	 ...
	 * @throws ServerApiException
	 */
	public List<IChatSession> getChatSessions() throws ServerApiException {
		// Test core availability
		ServerApiUtils.testCore();
		
		try {
			try {
				ArrayList<IChatSession> result = new ArrayList<IChatSession>();
