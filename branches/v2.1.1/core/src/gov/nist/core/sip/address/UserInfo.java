 ...
 * 
 * @author M. Ranganathan <mranga@nist.gov> <br/> Acknowledgement -- Lamine
 *         Brahimi Submitted a bug fix for a this class. <a href="{@docRoot}/uncopyright.html">This
...
public final class UserInfo {
	...
	public boolean equals(Object obj) {
		...
		if (!this.user.toLowerCase().equals(other.user.toLowerCase())) {
			return false;
		}
	...
	public String encode() {
		if (password != null)
			return new StringBuffer().append(user).append(Separators.COLON)
	...
	public void setUser(String user) {
		...
		if (user != null
				&& (user.indexOf(Separators.POUND) >= 0 || user
						.indexOf(Separators.SEMICOLON) >= 0)) {
