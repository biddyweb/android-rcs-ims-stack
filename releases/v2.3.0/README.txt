...
- Use an Alarm Manager for chat session inactivity timeout.
- Registration retry procedure (see new related RCS settings).
...
- Mantis #0013315	Contacts with number starting with 0033 are not correctly handled
